...
function() {
    ...
    var e = (l.navigator || {}).userAgent,
        ...
        t = z,
        f = !!a.document,
        M = !!n.documentElement && !!n.head && "function" == typeof n.addEventListener && "function" == typeof n.createElement,
        ...
        u = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter"].concat(C.map(function(c) {
            return c + "x";
    ...
    var Ec = {
        ...
        Fc = E.styles,
        Bc = "fa-layers-text",
        Dc = /Font Awesome 5 (Solid|Regular|Light|Brands)/,
        Xc = {
            Solid: "fas",
            Regular: "far",
            Light: "fal",
                    ...
                    R(c.querySelectorAll("*")).forEach(function(m) {
                        [":before", ":after"].forEach(function(l) {
                            var c = a.getComputedStyle(m, l),
                                h = c.getPropertyValue("font-family").match(Dc),
                                v = R(m.children).filter(function(c) {
    ...
    function Kc(c) {
        ...
        if (M) {
            var h = n.documentElement.classList,
                ...
                e = Object.keys(Fc),
                m = ["." + Bc + ":not([" + g + "])"].concat(e.map(function(c) {
                    return "." + c + ":not([" + g + "])";
                })).join(", ");
            if (0 !== m.length) {
                        ...
                        yc = new s(function(c) {
                            wc || R(c).forEach(function(c) {
                                if ("childList" === c.type && 0 < c.addedNodes.length && !pc(c.addedNodes[0]) && (O.searchPseudoElements && m(c.target),
                                    ...
                                    "attributes" === c.type && pc(c.target) && ~d.indexOf(c.attributeName))
